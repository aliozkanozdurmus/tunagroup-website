  ...
  return (
    <>
      ...
      <footer className="relative bg-navy-900 text-white overflow-hidden">
        ...
        {/* Main Footer Content */}
        <div className="relative z-10 max-w-7xl mx-auto px-4 lg:px-6 py-10 lg:py-12">
          <div className="flex flex-col md:grid md:grid-cols-2 lg:flex lg:flex-row lg:justify-between gap-12 lg:gap-10">
            {/* Company Info */}
            <motion.div
